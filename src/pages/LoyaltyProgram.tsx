...
const LoyaltyProgram = () => {
  ...
  const nextTier = loyaltyData?.tier === 'bronze' ? 'silver' :
                   loyaltyData?.tier === 'silver' ? 'gold' :
                   loyaltyData?.tier === 'gold' ? 'platinum' : null;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${tierColors[loyaltyData?.tier]} flex items-center justify-center`}>
              <Trophy Icon className="h-12 w-12 text-white" />
            </div>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Get bonus points for sharing your thoughts
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tiers && Object.entries(tiers).map(([key, tier]: [string, any], index) => (
              <motion.div
                key={key}
              ...
              >
                <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${tierColors[key]} flex items-center justify-center mx-auto mb-4`}>
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      transaction.type === 'earned' ? 'bg-green-600' :
                      transaction.type === 'redeemed' ? 'bg-red-600' :
