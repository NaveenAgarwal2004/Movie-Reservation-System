    ...
    <div className="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-white font-mono font-bold text-xl mb-2">
            {booking.reference}
          </p>
        ...
        >
          ...
          <div className="flex justify-center space-x-4">
            <a href="mailto:support@cinemax.com" className="text-red-400 hover:text-red-300 text-sm font-medium">
              Email Support
            </a>
            <span className="text-gray-600">|</span>
            <a href="tel:1800-123-4567" className="text-red-400 hover:text-red-300 text-sm font-medium">
              Call 1800-123-4567
            </a>
          </div>
        </motion.div>
